...
public class MultiImagePick extends AppCompatActivity {
	...
	public void btnChoosePhotosClick(View v){
		...
		if (selectedItems!= null && selectedItems.size() > 0) {
			Intent i = new Intent(MultiImagePick.this,ShowImagesActivity.class);
			i.putStringArrayListExtra("images",selectedItems);
			startActivity(i);
			Log.d(MultiImagePick.class.getSimpleName(), "Selected Items: " + selectedItems);
		} else{
			Toast.makeText(MultiImagePick.this, "Total photos selected: " + 0, Toast.LENGTH_SHORT).show();
		}
	}
	...
	private void showPermissionRationaleSnackBar() {
		Snackbar.make(findViewById(R.id.button1), getString(R.string.permission_rationale),
			...
			public void onClick(View view) {
				...
				ActivityCompat.requestPermissions(MultiImagePick.this,
